<template>
  <div
    ...
    class="m-1 flex h-20 w-shop_cart_item_small_w cursor-pointer justify-between rounded border-2 border-border_color shadow-xl hover:shadow-2xl xs:w-shop_cart_item_mid_w sm:m-3 sm:w-shop_cart_item_w"
  >
    <img :src="img_src" class="hidden w-32 object-cover sm:inline-block" alt="painting" />

    <div class="mx-2 flex w-2/4 flex-col justify-center">
      <div class="w-full truncate text-xs font-bold sm:text-base">«{{ name }}»</div>
